...
I enjoy building clean, scalable, and user-friendly mobile applications using modern technologies like Kotlin, Jetpack Compose, Swift, SwiftUI, and UIKit.

---

## 🚀 About Me

- 📱 Mobile Developer focused on Android and iOS
- 🤖 Android: Kotlin, Jetpack Compose, Coroutines, Flow
- 🍎 iOS: Swift, SwiftUI, UIKit
- 🧱 Interested in Clean Architecture, MVVM, and scalable app structure
- 🎨 Passionate about creating smooth, polished, and maintainable user interfaces
- 📚 Always learning and improving my mobile engineering skills
